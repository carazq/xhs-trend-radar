window.RADAR_DATA = {
  "trends": [
    ...
    },
    {
      ...
      "sources": [
        ...
        [
          "Variety / South Park Emmy win context",
          "https://au.variety.com/2026/tv/news/south-park-trump-emmy-win-outstanding-animated-program-40039/"
        ]
      ]
    }
  ],
  ...
  "aiSignals": [
    ...
    },
    {
      ...
      "sources": [
        ...
        [
          "Skill Leaderboard / agent skills weekly ranking",
          "https://www.skillleaderboard.com/"
        ]
      ]
    },
  ...
  "weeklySop": [
    {
      "title": "动态发现先行",
      "detail": "9/23 先扫音乐新专反应、Netflix 犯罪剧、witchy nostalgia、TikTok 平台格式和 AI skill repo，再反推二级搜索词。"
    },
    {
      "title": "主榜只收 exact 证据",
      "detail": "RAYE、Lizzie Borden、Practical Magic 2 与 Claude skills 今天都缺新的 exact 赞评证据，因此只进入 Summary/search cluster/watchlist。"
    },
    {
      "title": "窗口滚动保守",
      "detail": "Social 主榜继续只保留 9/08-9/23 窗口内且此前已精确复核过门槛的 ADÉLA 与 South Park。"
    },
    {
      "title": "GitHub 只写 API 样本",
      "detail": "9/23 GitHub feed 写 stars、forks、created_at、pushed_at 和产品方向；没有历史对照时不写周涨幅。"
    }
  ],
  "contentFormats": [
    "格式：search cluster 预警：今天看到什么、为什么不能进主榜、还差什么证据、如果升级该怎么写。",
    "格式：AI skill 商品化：教程热度、GitHub 新仓、职业流程、复用价值、审计风险。",
    "格式：音乐人格审计：新专 reaction、评论分歧、艺人人格、视觉母题、互动提问。",
    "格式：GitHub 产品信号：新仓、stars/forks、解决的工作流、不是涨幅榜、产品机会。",
    "格式：私域情报产品：聊天记录、只读检索、日报/follow-up、机会追踪、隐私边界。"
  ],
  "summarySparks": [
    {
      "title": "ADÉLA 仍是最稳新人 pop persona exact 样本",
